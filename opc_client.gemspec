Gem::Specification.new do |s|
  ...
  s.description = 'A command line client for the Oracle Public Cloud'
  ...
  s.add_dependency('OPC', '~> 0.2.2')
  s.executables = ['opclist','opcdelete', 'jcsmanage', 'opccreate', 'objstrg', 'ntwrk_app_updt', 'network',
                   'datagrid', 'dbcsmanage', 'jcsbkup', 'encrypt', 'computeinstlist', 'ntwrk_lst', 'blockstorage',
                   'ntwrk_rule_updt','orch_client']
                   
  s.rubygems_version = %q{1.6.2}
  s.summary = %q{Oracle_Public_Cloud_Client!}
